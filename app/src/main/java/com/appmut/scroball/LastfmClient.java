          ...
          for (ScrobbleResult result : results) {
            if (result.isSuccessful()) {
              if(result.isArtistCorrected() || result.isTrackCorrected()) { //Kai
                ...
                if((!scrobbleIdentifier.getTrack().equals("null") && !scrobbleIdentifier.getArtist().equals("null")) && (!scrobbleIdentifier.getTrack().equals("\"") && !scrobbleIdentifier.getArtist().equals("\"")) && !(scrobbleIdentifier.getTrack().equals("") || scrobbleIdentifier.getArtist().equals(""))){ //&& !lastScrobbledTracks.contains(trackAndArtist)){  //Kai
                  lastScrobbledTracks.add(scrobbleIdentifier);  //Kai
